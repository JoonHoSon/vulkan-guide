...
void vkUtil::copyImageToImage(VkCommandBuffer buffer, VkImage source, VkImage destination, VkExtent2D sourceSize,
    ...
    //
    // vkCmdCopyImage2() 함수는 속도는 빠르지만 두 이미지의 해상도가 반드시 같아야 하는 등의 제약이 있음
    //
